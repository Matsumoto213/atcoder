...
def find_good_integer(N):
    ...
    def quinary_to_good_integer(quinary_str):
        translation = {'0': '0', '1': '2', '2': '4', '3': '6', '4': '8'}
        return int(''.join(translation[digit] for digit in quinary_str))
    quinary_representation = to_quinary(N - 1)
    return quinary_to_good_integer(quinary_representation)

ans = find_good_integer(N)
print(ans)