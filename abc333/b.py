...
def is_equal_length_corrected(p1, p2, q1, q2):
    ...
    distance_p = min(abs(p2_pos - p1_pos), 5 - abs(p2_pos - p1_pos))
    distance_q = min(abs(q2_pos - q1_pos), 5 - abs(q2_pos - q1_pos))
    return distance_p == distance_q

print('Yes' if is_equal_length_corrected(S[0], S[1], T[0], T[1]) else 'No')